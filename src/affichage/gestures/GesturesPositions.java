...
public class GesturesPositions 
{
	...
	public GesturesPositions() {
		...
		allGestures.put(Cible.BNUI_G, new Gestures("BNUI", "g"));
		allGestures.put(Cible.BNUI_M, new Gestures("BNUI", "M"));
		allGestures.put(Cible.BNUI_P, new Gestures("BNUI", "P"));
		
		allGestures.put(Cible.G_B, new Gestures("G", "B"));
		allGestures.put(Cible.G_C, new Gestures("G", "C"));
		allGestures.put(Cible.G_G, new Gestures("G", "g"));
		allGestures.put(Cible.G_M, new Gestures("G", "M"));
		allGestures.put(Cible.G_P, new Gestures("G", "P"));
		
		allGestures.put(Cible.ICHGNW_B, new Gestures("ICHGNW", "B"));
		allGestures.put(Cible.ICHGNW_C, new Gestures("ICHGNW", "C"));
		allGestures.put(Cible.ICHGNW_G, new Gestures("ICHGNW", "g"));
		...
		allGestures.put(Cible.KVZ_G, new Gestures("KVZ", "g"));
		...
		allGestures.put(Cible.SR_G, new Gestures("SR", "g"));
		...
		allGestures.put(Cible.YNG_G, new Gestures("YNG", "g"));
		...
		allGestures.put(Cible.MTF_G, new Gestures("MTF", "g"));
		...
		allGestures.put(Cible.PDJ_G, new Gestures("MTF", "g"));
